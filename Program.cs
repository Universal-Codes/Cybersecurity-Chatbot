...
namespace ChatBot
{
    class CyberSecurityChatbot
    {
        ...
        {
            string filePath = @"C:\Users\RC_Student_lab\Desktop\Purple VS Code\CybersecurityChatbot\bin\Greeting.wav";
            ...
            try
            {
                using (SoundPlayer voice = new SoundPlayer(@"C:\Users\RC_Student_lab\Desktop\Purple VS Code\CybersecurityChatbot\bin\Greeting.wav"))
                {
